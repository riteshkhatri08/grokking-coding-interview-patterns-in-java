// https://www.educative.io/courses/grokking-coding-interview-patterns-java/minimum-window-substring
// https://leetcode.com/problems/minimum-window-substring/
// https://leetcode.com/problems/minimum-window-substring/submissions/1154082873
...
public class MinimumWindowSubstring {
    ...
    public static String minWindow(String s, String t) {
        ...
        int left = 0, right = 0, requiredchars = t.length(), minleft = 0, minright = Integer.MAX_VALUE;
        ...
        for (; right < charray.length; right++) {
            ...
            if (charcount[charray[right]] <= tcharcount[charray[right]]) {
                ...
                if (requiredchars == 0 && (right - left) < (minright - minleft)) {
                    ...
                    if ((minright - minleft + 1) == t.length()) {
                        break;
                    }
                }
            } else {
                // now we have more than enough of this character, time to slide
                if (charcount[charray[left]] > tcharcount[charray[left]]) {
